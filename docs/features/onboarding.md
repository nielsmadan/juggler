...
3. **Integration Hub**: Terminal setup (iTerm2, Kitty, and/or WezTerm), optional tmux env forwarding, and agent hook installation (Claude Code, OpenCode, Codex, Pi, Antigravity).
